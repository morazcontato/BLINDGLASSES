      ...
      <section className="bg-black text-white py-20 text-center" id="contato">
        <div className="max-w-7xl mx-auto px-5">
          <h2 className="text-2xl md:text-4xl font-bold mb-4">
            Escolha seu proximo oculos BLIND.
          </h2>
          <p className="text-gray-400 text-lg mb-8">
            Estilo, protecao e presenca em um so lugar.
          </p>
        ...
        <div className="max-w-7xl mx-auto px-5">
          <div className="flex flex-col md:flex-row justify-between items-start gap-10 mb-8">
            ...
            <div>
              ...
              <a
                href="#hero"
                className="block text-sm text-gray-400 mb-2 hover:text-[#4DA6FF] transition-colors"
              >
                Inicio
              </a>
              <a
              ...
              <a
                href="#contato"
                className="block text-sm text-gray-400 hover:text-[#4DA6FF] transition-colors"
              >
                Contato
              </a>
            </div>
